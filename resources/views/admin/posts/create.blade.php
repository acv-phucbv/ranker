...
@section('admin.posts.create', 'active open')

@section('page_styles')
    <link href="{{ asset('assets/global/plugins/bootstrap/css/bootstrap-fileinput.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <div class="form-group">
                        {{ Form::textarea('content', null, ['id' => 'post_content', 'class'=>'ckeditor form-control', 'rows' => 10, 'data-error-container' => '#editor2_error']) }}
        ...
        <div class="col-xs-12 col-sm-2">
            <div class="portlet light bordered">
                <div class="form-group">
                    <label class="mt-radio">
                        {{ Form::radio('status', '1', true, ['status' => '']) }}
                        {{trans("common.public")}}
                        <span></span>
                    </label>
                    <label class="mt-radio">
                        {{ Form::radio('status', '2', false, ['status' => '']) }}
            ...
            <div class="portlet light bordered">
                <div class="form-group">
                    <label>Tag:</label>
                    {{ Form::select('tags_id[]', $tags, null, ['id' => 'tag_list', 'class' => 'form-control', 'multiple']) }}
                </div>
            </div>
            <div class="portlet light bordered">
...
@section('page_plugin_scripts')
    <script src="{{ asset('assets/global/plugins/bootstrap/js/bootstrap-fileinput.js') }}" type="text/javascript"></script>
