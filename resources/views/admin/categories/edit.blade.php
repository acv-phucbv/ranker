    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6">
            <div class="portlet light bordered">
                <form method="post" action="{{ route('admin.categories.update', $category->id) }}" class="form-horizontal"  enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body card-block">
                        ...
                        <div class="has-warning form-group">
                            ...
                            <textarea type="text" id="description" class="form-control" name="description" cols="4">{{ $category->description}}</textarea>
                        </div>
                    </div>
